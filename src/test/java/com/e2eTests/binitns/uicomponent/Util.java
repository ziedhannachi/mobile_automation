...
import com.e2eTests.binitns.driver.AppDriver;
...
public class Util {
	...
	public static void longPress_gesturePlugin(WebElement el) {
		((JavascriptExecutor) AppDriver.getCurrentDriver()).executeScript("gesture: longPress",
	...
	public static void swipe_gesturePlugin(WebElement el, String direction) {
		((JavascriptExecutor) AppDriver.getCurrentDriver()).executeScript("gesture: swipe", ImmutableMap.of("elementId",
	...
	public static void dragNDrop_gesture(WebElement source, WebElement target) {
		((JavascriptExecutor) AppDriver.getCurrentDriver()).executeScript("gesture: dragAndDrop", ImmutableMap.of(
				"sourceId", ((RemoteWebElement) source).getId(), "destinationId", ((RemoteWebElement) target).getId()));
	}
